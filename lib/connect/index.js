...
function connect(mapStateToProps, mapActionToProps) {
  return function connectComponent(Component) {
    ...
    var onStateChange = function onStateChange() {
      ...
      var states = mapStateToProps(store.getState(), _helpers.wrapOwnPropsFunc.call(this));
    ...
    return function (_Component) {
      ...
      function _class() {
        ...
        var store = (0, _store.getStore)();
        var ownProps = _helpers.wrapOwnPropsFunc.call(_this2);
        ...
        var wrapActions = (0, _helpers.wrapActionsFunc)(mapActionToProps(store.dispatch, ownProps));
